...
1. WHEN Generate_LambdaがキャラクターをCharacters_Tableに保存した後、THE **Bedrock_Client** SHALL `anthropic.claude-haiku-4-5-20251001-v1:0`（ap-northeast-1リージョン）を使用してバックグラウンドストーリーを生成する
